...
{
    public class HotelWithRoomsCreateValidator : AbstractValidator<HotelWithRoomsCreateDto>
    {
        public HotelWithRoomsCreateValidator(RoomForHotelWithRoomCreateValidator roomValidator)
        {
            RuleFor(x => x.Name)
